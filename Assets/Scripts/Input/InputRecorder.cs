...
namespace Inputs
{
    ...
    {
        //Записывает инпуты машины игрока каждый Update, имеет в себе два поля
        //_recordingInputs - инпуты, которые в данный момент записываются
        //_recordedInputs - инпуты, которые уже записаны с прошлого заезда
        //и сейчас используются в PhantomCar. Метод MoveInputsToRecorded -
        //перемещает инпуты из одного поля в другое.
